...
func printUsage(w io.Writer) {
	...
	fmt.Fprintln(w, "  shipproof pack --comment <file>")
	fmt.Fprintln(w, "  shipproof pack --payload <file>")
	fmt.Fprintln(w, "  shipproof pack --attach <file> --signature <path> --certificate <path> --subject <rev>")
